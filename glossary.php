                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <p>English is the common language used in the tea industry throughout the world. However, it is English with a difference. A grade of a leaf for example refers to the size of the leaf particle, while dust is the term used to describe the smallest leaf particle. Large leaf, good quality China tea is called stringy, and made tea is the state of the tea at the end of production and not tea that has been brewed in a pot.
                                                    ...
                                                    Source: International Tea Committee, London. </br> </br>  Chinese Type Gun Powder Special – tiny particles of tea resembling pellets, generally having a smoky character in the cup.

                                                    Young Hysen - large particles, three times the size of Gun Powder.

                                                    Green Tea Fannings - similar to BOPF. Suitable for tea bags.

                                                    Sencha - Japanese preparation of leafy Green tea with a special delicate character consumed plain without any additives.

                                                    Sencha Fannings - smaller particles of the same tea, used in tea bags.
                                                </p>
                                            </div>
                                            <div class="col">
                                               <img src="assets/img/bg/bg-01.png">
                                            </div>
                                        </div>
