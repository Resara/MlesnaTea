        ...
        <div class="row">
            ...
            <div class="col-lg-5 offset-lg-1">
                ...
                <div class="common-section-content">
                    <!--Section Title-->
                    <div class="section-title padding-bottom-20">
                        <h2 class="heading-02"> Helsinki Tea</h2>
                    </div>
                    <!--// Section Title End-->
                    <div class="paragraph">
                        <h5>Ingredients -</h5>
                        <p>
                            ½ litre (18 fl oz/2 cups) water <br>
                            4 – 6 teaspoons tea <br>
                            50 – 100g (2 – 4 oz/¼ - ½ cup) sugar or 4 tablespoons sugar syrup <br>
                            1 apple <br>
                            1 untreated lemon <br>
                            4 fresh peppermint leaves <br>

                        </p>
                        <br>
                        <h5>Method -</h5>
                        <p>
                            Use boiling water to brew the tea for about 4 minutes before straining it off and leaving it to cool.
                            To make the sugar syrup, dissolve the sugar in 8 tablespoons boiling water to form a thick syrup.
                            Drop ice cubes into 4 cups or glasses and add 1 tablespoon of sugar syrup to each.
                            Peel the apple and slice it thinly; place the slices over the ice.
                            Top up with cold tea, and garnish with peppermint leaves and a slice of lemon.
